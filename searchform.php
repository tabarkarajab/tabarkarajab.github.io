<form action="<?php echo esc_url( home_url( '/' ) ); ?>" class="searchform" method="get" role="search">
	<div>
		...
		<button class="searchsubmit" type="submit"><i class="olsen-icons olsen-icons-search"></i><span class="screen-reader-text"><?php echo esc_html_x( 'Search', 'submit button', 'olsen-light' ); ?></span></button>
	</div>
</form>
